...
- Current exports provide phase-1 runtime API scope (`init/run/flip/quit/btn/btnp/btnr/btnv/cls/pset/pget/line/rect/rectb/circ/circb/blt/play/playm/stop/load/save`).
