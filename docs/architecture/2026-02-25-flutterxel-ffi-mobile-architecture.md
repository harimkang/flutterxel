...
1. Dart API layer:
   - Exposes Pyxel-like APIs (`init/run/flip/quit/btn/btnp/btnr/btnv/cls/pset/pget/line/rect/rectb/blt/play/playm/stop/load/save`)
...
- Core API skeleton: `init/run/flip/quit/btn/btnp/btnr/btnv/cls/pset/pget/line/rect/rectb/blt/play/playm/stop/load/save`
