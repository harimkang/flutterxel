...
dart run flutterxel_tools:flutterxel_tools release-check --tag v0.0.14
dart run flutterxel_tools:flutterxel_tools release-bump --version 0.0.14
...
```bash
bash packages/flutterxel_tools/tool/check_release_versions.sh --tag v0.0.14
```
...
```bash
bash packages/flutterxel_tools/tool/bump_release_versions.sh --version 0.0.14
```
